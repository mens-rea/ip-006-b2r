...
<link href="http://netdna.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <body>
        ...
        <h5>Groups to the same destination is available</h5>

        <div class="group-cont">
          <h3>Group Id: 0945721</h3>
          <h4>Group Leader: Juaning</h4>
          <div class="riders-cont">
            <div class="rider-frame"></div>
            <div class="rider-frame"></div>
            <div class="rider-frame"></div>
            <div class="rider-frame"></div>
          </div>
        ...
        <a id="join-button" class="gb-menu-items" href="start.php"><i class="fa fa-home"></i>JOIN GROUP</a>
